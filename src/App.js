...
<div>
  ...
  <div className="header">
          ...
          <div className="logo" style={{color: 'white', fontSize: 14, marginLeft: 20}}>
              <p>Spotify Shraddha</p>
          </div>

          <span className="login" style={{float: 'right', marginRight: 40}}>
              <a href="https://spotify-backend-shra.herokuapp.com:8888/login"> <button type="button" className="btn btn-success" style={{height: 28,fontSize:11}}>Log In to Spotify</button> </a>
          </span>
  </div>
  ...
  <div className="row" style={{marginLeft: "6%", marginTop: 15}}>
              <div className="col-sm-10">
                ...
                {/* #391285*/
                  ...
                  return (
                  <div className="row" style={{marginTop: 20, backgroundColor: "black", color: "white",height: "auto", paddingBottom: 10, width: "90%", borderRadius: 5,marginLeft: "6%"}}>
                    <div className="col-sm-10">
                        ...
                        <div className="col-sm-10" style={{float: "right", marginRight: "5%"}}>
                          ...
                          <div className="col-sm-5" style={{paddingLeft: 20, marginLeft: "3%", paddingTop: 8, color: "white", fontSize: 10}}>
                            ...
                            <a target="_blank" href={track.external_urls.spotify}><button style={{height: 25, borderRadius: 4}}>Open in Spotify</button></a>
                          </div>
                        </div>
                    </div>
                  </div>
